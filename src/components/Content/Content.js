        ...
        <div className={cx('wrapper')}>
            ...
            <div className={cx('body')}>
                ...
                <p className={cx('description')}>
                    ...
                    oil of "earning their money in other people's blood".
                    <br />
                    <br />
                    In an interview with the BBC, President Zelensky singled out Germany and Hungary, accusing them of
                    blocking efforts to embargo energy sales, from which Russia stands to make up to £250bn ($326bn)
                    this year.
                </p>
            </div>
        </div>
